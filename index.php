<?php include('header.php'); ?>
		...
		<main role="main">
			<!--<div class="jumbotron">
	        <div class="container">
	          <h1 class="display-3">Welcome, ApietTravel!</h1>
	          <p>
	          	En la sierra, con el sonido de quenas en el viento, respirarás el aire puro de los Andes y contemplarás con devoción la armonía del hombre con la naturaleza en Apurímac.
	          </p>
				...
				<div class="col-sm-12 col-md-6">
					...
					<form method="POST" action="">
					  	<div class="form-group">
					    	...
					    	<input class="form-control" type="text" placeholder="Nombres y Apellidos" id="txtNombresApellidos">
					  	</div>
					  	<div class="form-group">
					  	...
					  	<div class="form-group">
					    	...
					    	<input class="form-control" type="text" placeholder="Asunto" id="txtAsunto">
					  	</div>
					  	<div class="form-group">
						    <label for="txtComentarios">Comentarios</label>
						    <textarea class="form-control" id="txtComentarios" placeholder="Comentarios" rows="3"></textarea>
					  	</div>
